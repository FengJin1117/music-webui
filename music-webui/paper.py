...
with gr.Blocks(title="音乐创作系统") as demo:
    ...
    with gr.Tabs():
        ...
        with gr.TabItem("歌词评估"):
            ...
            def evaluate_lyrics(lyrics):
                ...
                <table border="1" style="border-collapse: collapse; width: 100%;">
                    ...
                    <tr><td>Dist-1</td><td>76.3</td></tr>
                    <tr><td>Dist-2</td><td>44.3</td></tr>
                    <tr><td>1-gram 重复率</td><td>9.1</td></tr>
                    <tr><td>2-gram 重复率</td><td>14.3</td></tr>
                </table><br/>
                """
                results += diversity
                yield results
                ...
                <table border="1" style="border-collapse: collapse; width: 100%;">
                    <tr><th>指标</th><th>得分</th></tr>
                    <tr><td>BERTScore</td><td>0.824</td></tr>
                </table><br/>
                """
                results += semantics
                yield results
                ...
                <table border="1" style="border-collapse: collapse; width: 100%;">
                    <tr><th>指标</th><th>得分</th></tr>
                    <tr><td>PPL（困惑度）</td><td>11.4</td></tr>
                </table>
                """
                results += fluency
                yield results
        ...
        with gr.TabItem("音乐评估"):
            gr.Markdown("## 🎼 音乐质量评估\n上传音频，系统将输出关键指标并与SOTA模型（如 Suno）对比雷达图。")
            ...
            def evaluate_music_fixed(music_path):
                ...
                <table border="1" style="border-collapse: collapse; width: 100%;">
                    <tr><th>指标</th><th>得分</th></tr>
                    <tr><td>MCD (dB)</td><td>3.8</td></tr>
                    <tr><td>SingMOS</td><td>4.5</td></tr>
                    <tr><td>SI-SDR (dB)</td><td>13.7</td></tr>
                    <tr><td>STOI</td><td>0.91</td></tr>
                </table>
                """
